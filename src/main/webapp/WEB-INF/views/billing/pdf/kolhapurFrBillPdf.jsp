...
<body>
	...
	<c:set var="maxRowCount" value="26" />
	<div style="text-align: center; font-size: 12px;"><b>TAX INVOICE </b></div>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0"
			...
			<tr>
				...
				<td width="60%" colspan="6" rowspan="2"
					...
					<p style="color: #000; font-size: 10px; text-align: left; margin: 0px 90px;">&nbsp;Name & Address of Licensee:<br></br></p>
					
					<img style="float: left; " src="${pageContext.request.contextPath}/resources/img/minlogo.png" alt="" />
					
					<h4 style="color: #000; font-size: 16px; text-align: left; margin: 05px; float: left; margin-left:5px; margin-top: 20px">&nbsp;${frDetails.company.compName}</h4>
					<p style="color: #000; font-size: 10px; text-align: left; margin: 0px; display: inline-block; width: 100% ">&nbsp;
				...
				<td colspan="4" width="40%" 
					...
					<p
						...
						ORIGINAL - FOR BUYER <br /> DUPLICATE - FOR TRANSPORTER/ACESSEE<br/>MODE OF TRANSPORT - BY ROAD
					</p>
				</td>
			...
			<td colspan="4" width="40%" 
					...
					<b>${frDetails.partyName}</b>  <br > 
						<span style="font-size: 10px;"> ${frDetails.frAddress}${frDetails.exVarchar1} </span><br>
						<span style="font-size: 10px;"> Place Of Supply: -${frDetails.exVarchar2} </span><br>
			...
			<tr>
				...
				<td width="50%" colspan="5"
					...
					<p
						...
						of supply: &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; ${Constants.STATE}    &nbsp;&nbsp;&nbsp;&nbsp; --%>&nbsp; Vehicle No :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${frDetails.vehNo}&nbsp;&nbsp;</p>
				</td>
			</tr>
		...
		<table width="100%" border="1" cellpadding="0" cellspacing="0"
			...
			<tr>
				...
				<td align="center" width="5%" rowspan="2"
					style="border-bottom: 1px solid #313131; border-left: 1px solid #313131; padding: 10px; color: #000; font-size: 10px;">Base Rate</td>
				<td align="center" width="5%" rowspan="2"
...
<td
								...
								<td align="right"
									style="border-left: 1px solid #313131; padding: 3px 5px; color: #000; font-size: 12px;"><fmt:formatNumber
										...
										value="${(billDetails.sgstRs)+(billDetails.cgstRs)+(billDetails.cessRs)+(billDetails.taxableAmt)+(billDetails.igstRs)}" /></td>
											<c:set var="acttotal" value="${acttotal+(billDetails.sgstRs)+(billDetails.cgstRs)+(billDetails.cessRs)+(billDetails.taxableAmt)+(billDetails.igstRs)}" />
							</tr>
						</c:when>
					</c:choose>
				</c:forEach>
   ...
   <fmt:formatNumber type="number"
							minFractionDigits="0" 	  groupingUsed = "false" maxFractionDigits="0" value="${totalAmt+totalCgst+totalSgst+totalCess+totalIgst}" var="totAmt"/>
				...
				<td align="right"
					style="border-left: 1px solid #313131; border-bottom: 1px solid #313131; padding: 4px; color: #000; font-size: 12px;"><b>
							<fmt:formatNumber type="number"
							minFractionDigits="2" 	maxFractionDigits="2"   groupingUsed = "false" value="${totAmt-(totalAmt+totalCgst+totalSgst+totalCess+totalIgst)}"/>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0"
							...
							<td align="center" width="9%" colspan="2"
								style="border-top: 0px solid #313131; padding: 2px; color: #000; font-size: 13px; text-align: center;"><b>Grand
									Total: Rs. </b>&nbsp;&nbsp;<b><fmt:formatNumber type="number"
										value="${totAmt}" /></b></td>
										<p style="color: #000; padding-right:25px; font-size: 9px; text-align: right; margin: 0px;" >Amount of tax subject to reverse charge

									Certify that the particulars given above are true and correct.</p>
						</tr>
			...
			<tr>
				<td colspan="" width="50%"
					...
					<p style="width: 50%" >   Certified that the particulars given above are true and correct .
    Note: All Fresh Cream products to be refrigerated or consumed within one hour 
    Warranty : we hereby certify that food mentioned in this invoice is warranted to be of the nature and quality which it purports to be . 
    Subject to Jurisdiction</p>
					<p
