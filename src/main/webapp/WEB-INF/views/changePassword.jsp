				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="login_left">
							<form id="form-forgot"
								action="${pageContext.request.contextPath}/changeToNewPassword"
								method="post">
								<h3 class="login_head">Change Password</h3>

								<div class="form-group">
									<div class="controls">
										<input type="password" placeholder="Enter New Password" id="newPass" name="newPass" class="form-control" required />
									</div>
								</div>

								<div class="form-group">
									<div class="controls">
										<input type="password" placeholder="Confirfm New Password" class="form-control" id="confrmPass" name="confrmPass" 
											required />
									</div>
								</div>
