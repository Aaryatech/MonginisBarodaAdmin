...
<div class="text-right">
			...
			<div class="login_bx">
				<div class="row">
					<div class="col-md-6">
						<div class="login_left">
							<form class="login100-form validate-form" id="form-login" action="getUserInfo" method="post">
				
			     
					<h2 class="login_head">Forgot password</h2>
					

					<div class="wrap-input100 validate-input" data-validate="Valid mobile is required">
						<input class="input100" type="text" id="mobNo" name="mobNo" placeholder="Enter regisered mobile No." autocomplete="off">
						<span class="focus-input100-1"></span>
						<span class="focus-input100-2"></span>
					</div> 
					<div class="container-login100-form-btn m-t-20">
