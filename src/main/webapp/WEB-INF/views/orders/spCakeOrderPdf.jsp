	...
	<c:forEach items="${spCakeOrder}" var="spCakeOrder" varStatus="count">
		...
		<c:choose>
			<c:when test="${count.index/2==0}">
				<c:set var="cls" value="floatedTable"></c:set>
			</c:when>
			<c:otherwise>
				<c:set var="cls" value="floatedTable1"></c:set>
			</c:otherwise>
		</c:choose>

		<table
			style="border-bottom: 1px solid grey; margin-top: 25px; margin-right: 19px; margin-bottom: 35px; margin-left: 45px;"
			class="${cls}">
			<tbody>
...
<td style="width: 425px; height: 20px; border-bottom: 1px solid; font-size: 19px;">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; M.R.P<strong>:</strong>&nbsp; &nbsp; ${spCakeOrder.slipMrp}</td>
				...
				<tr style="height: 20px; border-top: 1px solid black;">
					<td
						...
						&nbsp;&nbsp;DEL DT&nbsp; &nbsp;&nbsp;<strong>:</strong>
					</td>
					<td
						style="width: 425px; height: 20px; font-size: 19px; font-weight: bold; border: 1px solid;">&nbsp;
						&nbsp; ${spCakeOrder.spDeliveryDate} --
						${spCakeOrder.spDeliveryPlace}</td>
				</tr>
				<tr style="height: 20px;">
					<td
						style="width: 125px; height: 20px; border: 1px solid; font-size: 19px;">&nbsp;
						&nbsp;&nbsp;ORD DT &nbsp;<strong>:</strong>
					</td>
					<td
				...
				<tr style="height: 20px;">
					...
					<td
						style="width: 125px; height: 20px; border-top: 1px solid; border-left: 1px solid; border-right: 1px solid; font-size: 19px;">&nbsp;
						&nbsp;&nbsp;SHOP&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;<strong>:</strong>
					</td>
					<td
...
<td style="width: 425px; height: 20px; font-size: 20px; border-bottom: 1px solid; border-left: 1px solid; border-right: 1px solid;">&nbsp; &nbsp; <strong>${frCity}</strong></td>
				...
				<tr style="height: 20px;">
					...
					<td
						style="width: 125px; height: 23px; border: 1px solid; font-size: 19px;">&nbsp;
				...
				<tr style="height: 23px;">
					<c:set var="spfName" value="${fn:toUpperCase(spCakeOrder.spfName)}" />
					<td
						style="width: 125px; height: 20px; border-top: 1px solid; border-left: 1px solid; border-right: 1px solid; font-size: 19px;">&nbsp;
						&nbsp;&nbsp;FLAV&nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;<strong>:</strong>
					</td>
					<td
						style="width: 425px; height: 20px; font-size: 19px; font-weight: bold; border-top: 1px solid; border-left: 1px solid; border-right: 1px solid;">&nbsp;
						&nbsp; ${spfName}</td>
...
<td style="width: 425px; font-size: 19px; height: 20px; border-bottom: 1px solid; border-left: 1px solid; border-right: 1px solid;">&nbsp;</td>
				...
				<tr style="height: 20px;">
					...
					<td
						style="width: 125px; height: 30px; border-bottom: 1px solid; border-top: 1px solid; border-left: 1px solid; border-right: 1px solid; font-size: 19px;">&nbsp;&nbsp;&nbsp;&nbsp;SPL.INST<strong>:</strong></td>
					<td
						style="width: 425px; height: 65px; padding-left: 5px; font-weight: bold; border-bottom: 1px solid; border-top: 1px solid; border-left: 1px solid; border-right: 1px solid; font-size: 13px;">&nbsp;
						${spInstructions}</td>
...
<td style="width: 425px; height: 20px; border-bottom: 1px solid; border-left: 1px solid; border-right: 1px solid; font-size: 19px;">&nbsp; &nbsp; ${spInstructions}</td>
 --%>
				<tr style="height: 20px;">
					<td
						style="width: 125px; border-left: 1px solid; height: 20px; font-size: 19px;">&nbsp;&nbsp;&nbsp;&nbsp;PHOTO
						&nbsp;&nbsp;<strong>:</strong>
					</td>
					<td
						style="width: 425px; border-left: 1px solid; height: 20px; font-size: 19px; border-right: 1px solid;">&nbsp;&nbsp;&nbsp;&nbsp;
							
					<c:forEach items="${uploadedPics}" var="picNo" varStatus="cnt" >
					<c:choose>
						<c:when test="${picNo ne '' }">
						<a href="${imgUrl}${picNo}" height="60"
									width="60" style="border: medium;" alt="NA1" target="_blank;">PHOTO${cnt.index+1}</a>
						</c:when>
						<c:otherwise>
						NA
