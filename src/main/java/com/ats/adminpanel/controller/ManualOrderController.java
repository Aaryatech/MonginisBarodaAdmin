...
public class ManualOrderController {
	...
	@RequestMapping(value = "/showManualOrder_OLD", method = RequestMethod.GET)
	public ModelAndView showManualOrder_OLD(HttpServletRequest request, HttpServletResponse response) throws IOException {
	...
	public @ResponseBody ManualOrderMenuAndDate getItemsOfMenuIdWithDate(HttpServletRequest request,
		...
		try {
			...
			map.add("frId", frId);
			try {
				menu = restTemplate.postForObject(Constants.url + "getFrMenuConfigureByMenuFrId", map,
	...
	// Anmol------->6/12/2019-----------------------
	@RequestMapping(value = "/getItemsOfMenuIdWithDate_OLD", method = RequestMethod.GET)
	public @ResponseBody ManualOrderMenuAndDate getItemsOfMenuIdWithDate_OLD(
			@RequestParam(value = "menuId", required = true) int menuId,
			@RequestParam(value = "frId", required = true) int frId,
			@RequestParam(value = "by", required = true) int by,
			@RequestParam(value = "ordertype", required = true) int ordertype) throws ParseException {
	...
	@RequestMapping(value = "/getItemsByCatIdManOrder_OLD", method = RequestMethod.GET)
	public @ResponseBody List<ItemForMOrder> getItemsByCatIdManOrder_OLD(HttpServletRequest request,
			HttpServletResponse response) {
	...
	@RequestMapping(value = "/generateManualBill_OLD", method = RequestMethod.POST)
	public String generateManualBill_OLD(HttpServletRequest request, HttpServletResponse response) {
